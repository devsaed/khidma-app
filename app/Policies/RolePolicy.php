...
class RolePolicy
{
    ...
    {
        return $authUser->hasPermissionTo('Read-Roles')
    ...
    {
        return $authUser->hasPermissionTo('Create-Role')
        ? $this->allow() : $this->deny('You have no permission for this action');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update( $authUser, Role $role)
    {
        return $authUser->hasPermissionTo('Update-Role')
        ? $this->allow() : $this->deny('You have no permission for this action');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete($authUser, Role $role)
    {
        return $authUser->hasPermissionTo('Delete-Role')
        ? $this->allow() : $this->deny('You have no permission for this action');
    }
