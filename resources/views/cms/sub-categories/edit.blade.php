                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="image-input image-input-empty image-input-outline" id="kt_image_5"
                                style="background-image: url({{Storage::url('sub_categories/'.$subCategory->image)}})">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <span class="switch switch-outline switch-icon switch-success">
                                <label>
                                    <input type="checkbox" @if($subCategory->active) checked @endif id="active">
                                    <span></span>
                                </label>
                            </span>
                        </div>
...
<script>
    ...
    function performEdit(){
        ...
        store('/cms/admin/sub-categories/{{$subCategory->id}}', formData, '/cms/admin/sub-categories');
    }
</script>
@endsection