            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$admin->mobile}}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            <span
                                {{-- class="label label-lg {{!is_null($admin->email_verifier_at) ? 'label-light-success' : 'label-light-danger'}}">{{$admin->verified_status}}</span> --}}
                                class="label label-lg @if($admin->email_verifier_at != null) label-light-success @else label-light-danger @endif label-inline"">{{$admin->verified_status}}</span>
                        </td>
                        <td>
                            <span
                                class="label label-lg @if($admin->active) label-light-success @else label-light-danger @endif label-inline">{{$admin->active_status}}</span>
                        </td>
