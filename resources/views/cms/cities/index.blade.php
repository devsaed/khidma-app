...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        ...
        <div class="card-toolbar">
            <a href="{{route('cities.create')}}" class="btn btn-info font-weight-bolder font-size-sm">New City</a>
        </div>
        @endcan
    </div>
    <!--end::Header-->
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$city->id}}</a>
                        </td>
                        <td class="pl-0">
                            <a href="#"
                        ...
                        <td class="pr-0">
                            <span class="btn btn-light-primary font-weight-bolder font-size-sm">({{$city->users_count}})
                                User/s</span>
                        </td>
