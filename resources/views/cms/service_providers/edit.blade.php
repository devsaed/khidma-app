            ...
            <form id="create-form">
                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="category_id"
                                    ...
                                    <option value="{{$category->id}}" @if($category->id == $serviceProvider->category_id)
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="city_id"
                                    ...
                                    <option value="{{$city->id}}" @if($city->id == $serviceProvider->city_id)
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input  type="text"  value="{{$serviceProvider->name}}" class="form-control" id="name" placeholder="Enter name" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" value="{{$serviceProvider->mobile}}" class="form-control" id="mobile" placeholder="Enter Mobile Number" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" value="{{$serviceProvider->email}}" class="form-control" id="email" placeholder="Enter Email" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <textarea class="form-control"  id="description" rows="3" placeholder="Description">{{$serviceProvider->description}}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <span class="switch switch-outline switch-icon switch-success">
                                <label>
                                    <input type="checkbox" @if($serviceProvider->active) checked @endif id="active">
                                    <span></span>
                                </label>
                            </span>
                        </div>
...
<script>
    ...
    function performStore(){
        ...
        store('/cms/admin/service-providers/{{$serviceProvider->id}}', formData, '/cms/admin/service-providers');
