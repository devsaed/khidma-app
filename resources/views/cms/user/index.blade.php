            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <span
                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$user->city->name ?? '-'}}</span>
                        </td>

                        <td class="pl-0">
                            <span
                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$user->mobile ?? '-'}}</span>
                        </td>
                        ...
                        <td class="pr-0">
                            <a href="{{route('user.edit-permissions',$user->id)}}"
                                class="btn btn-light-primary font-weight-bolder font-size-sm">({{$user->permissions_count}})
                                Permission/s</a>
                        </td>
